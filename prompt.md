...
Build an MCP server using the Sleeper Fantasy Football API. The docs are here https://docs.sleeper.com. Please provide all features of the API as tools of the MCP. We'll probably want to store the league_id as a variable so that users of the MCP can specify their league id. My league id is 1257057278398300160 for example.

There shouldn't be any need for auth with this API.
